...
//    use \MailThief\Testing\InteractsWithMail;
    ...
    public function testSeatExchangeNotifyEmail()
    {
        ...
        dispatch(new SendEmailOnApplySeatExchange(new \App\Events\SeatExchangeApplied($seat_exchange, User::find($delegation_1->id), Request::create("/"))));
